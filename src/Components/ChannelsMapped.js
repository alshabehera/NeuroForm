...
const cloneSelect = () =>{
  ...
  document.getElementById("btn").value="Close Curtain";}
...
<Item >
  <Box>
      ...
      <td><nobr><Button id="btn" sx={{textTransform: 'none'}}startIcon={<AddIcon color="error"/>} color="error"  onClick={cloneSelect}>Add Backup</Button></nobr></td>
...
<Item >
 ...
 right: "7px" }} variant="contained">  <Link style={{color:"black"}} className="nav-link" to="/PreviewConfig">Next</Link  ></Button></Grid>
